...
def get_file_list():
	...
	files.append("patches/enzo/notes.txt")
	files.append("patches/enzo/krome_enzo.sh")
	...
	files.append("patches/enzo/GridKrome.h")
	...
	files.append("tests/collapseUV/plot.gps")
        files.append("tests/collapseUV_Xrays")
	files.append("tests/collapseUV_Xrays/test.f90")
	files.append("tests/collapseUV_Xrays/plot.gps")
