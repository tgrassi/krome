...
fileNames = ["krome_user.f90", "krome_all.f90"]
...
for row in alltext.split("\n"):
    ...
    if isfun or issub:
        ...
        if searchName in ffname.lower() and searchName!="":
            okList = True
        #search in function description
        if searchDescription in storecom.lower() and searchDescription != "":
            okList = True
        #search in name+description
        if (searchAll in storecom.lower() or searchAll in ffname.lower()) and searchAll!="":
            okList = True
        #if search strings are all empty skip
        if searchAll=="" and searchName=="" and searchDescription=="":
            okList = True
